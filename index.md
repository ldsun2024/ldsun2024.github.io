  ...
  <div class="home-layout">
      ...
      <div class="sidebar-card profile-card">
        ...
        <div class="social-links">
          ...
          <a href="mailto:{{ site.email }}" title="Email">
            <svg height="18" width="18" viewBox="0 0 24 24" fill="#666"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
          </a>
        </div>
      </div>
    ...
    <main class="home-main">
      <div class="section-header">
        ...
        <span class="section-count">共 {{ site.posts | size }} 篇</span>
      </div>
